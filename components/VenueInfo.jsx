        ...
        <div className='venue__info'>
          ...
          <div className='venue__info--description'>
            <p data-cy='venue-info'>
              ...
              vi allt från utbildningar, konferenser till stora fester och tar fram helhetslösningar efter era önskemål med fokus på detaljer, god kommunikation och service.
